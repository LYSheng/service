...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            this.callBackName = params.callBackName;
        ...
        finish: function(e) {
            ...
            if (_self.callBackName) {
                var nameArry = [provinceText, cityText, countyText];
                _self.callBackName(nameArry);
            } else {
            ...
            if (_self.callBackFun) {
                var arry = [provinceCode, cityCode, countyCode];
