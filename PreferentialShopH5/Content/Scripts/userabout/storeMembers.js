                ...
                success: function (obj) {
                    ...
                    if (obj.isBizSuccess) {
                        ...
                        for (var i = 0; i < obj.data.length;i++){
                            ...
                            _html += '<p class="flex1 time fs14">' + obj.data[i].payEndTime.substr(0, 4) + '/' + obj.data[i].payEndTime.substr(5, 2) + '/' + obj.data[i].payEndTime.substr(8, 2) + '</p>';
                            _html += '<p class="flex1 name fs14">' + obj.data[i].userName + '</p><p class="flex1 money fs14">' + obj.data[i].investmentAmount.toFixed(2) + '</p></li>';
                        }
