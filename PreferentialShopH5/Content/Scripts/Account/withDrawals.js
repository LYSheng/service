...
var resetModel = function () {
    ...
    self.withCardList = function () {
        window.location.href = "/userAbout/withCardList"
    };
        ...
        apiRequest({
            ...
            success: function (obj) {
                ...
                if (obj.isBizSuccess) {
                    ...
                    location.replace("/userAbout/withDrawalsSuccess?bankCardNum=" + params.BankCardNum + "&withdrawalsAmount=" + params.WithdrawalsAmount + "&cardName=" + bankSelect.cardName); 
                }
            },
            error: function (obj) {
                $(".adraddBtn").removeClass("poiEventsNone");
...
$(".chooseB").click(function () {
    if (_choice == 1) {
        ...
        window.location.replace("/userAbout/withDrawalsDividends");
    } else {
        window.location.href = "/userAbout/withBankAction?bankCardId=" + $(this).data("bankid");
    }

})
$("#addAddress").click(function () {
    if (_choice == 1) {
        window.location.href = "/userAbout/withCardDetail?choice=" + _choice;
    } else {
        window.location.href = "/userAbout/withCardDetail";
    }
